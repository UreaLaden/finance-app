...
import byteWise from '@/assets/images/avatars/byte-wise.jpg';
...
import greenPlate from '@/assets/images/avatars/green-plate.jpg';
...
import masonMartines from '@/assets/images/avatars/mason-martines.jpg';
...
import savoryBytes from '@/assets/images/avatars/savory-bytes.jpg';
...
export const AvatarRegistry = {
    "aqua-flow-utilities": aquaFlowUtilities,
    "buzz-marketing-group": buzzMarketingGroup,
    "byte-wise": byteWise,
    "daniel-carter": danielCarter,
    "ecofuel-energy": ecofuelEnergy,
    "elevate-education": elevateEducation,
    "ella-phillips": ellaPhillips,
    "emma-richardson": emmaRichardson,
    "ethan-clark": ethanClark,
    "flavor-fiesta": flavorFiesta,
    "green-plate": greenPlate,
    "harper-edwards": harperEdwards,
    "james-thompson": jamesThompson,
    "liam-hughes": liamHughes,
    "lily-ramirez": lilyRamirez,
    "mason-martines": masonMartines,
    "nimbus-data-storage": nimbusDataStorage,
    "pixel-playground": pixelPlayground,
    "rina-sato": rinaSato,
    "savory-bytes": savoryBytes,
    "sebastian-cook": sebastianCook,
    "serenity-spa-and-wellness": serenitySpaAndWellness,
    "sofia-peterson": sofiaPeterson,
    "spark-electric-solutions": sparkElectricSolutions,
    "sun-park": sunPark,
    "swift-ride-share": swiftRideShare,
    "technova-innovations": technovaInnovations,
    "urban-services-hub": urbanServicesHub,
    "william-harris": williamHarris,
    "yuna-kim": yunaKim    
}

export type AvatarKey = keyof typeof AvatarRegistry;